...
use Carta\CartaBundle\Entity\Tipo;
use Carta\CartaBundle\Form\TipoType;
...
class TipoController extends Controller
{
     ...
     * @Method("POST")
     * @Template("CartaCartaBundle:Tipo:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CartaCartaBundle:Tipo')->find($id);
     ...
     * @Method("PUT")
     * @Template("CartaCartaBundle:Tipo:edit.html.twig")
     */
